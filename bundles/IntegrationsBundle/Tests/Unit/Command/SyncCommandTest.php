...
namespace Milex\IntegrationsBundle\Tests\Unit\Command;

use Milex\IntegrationsBundle\Command\SyncCommand;
 ...
 * MILEX_INTEGRATION_SYNC_IN_PROGRESS which breaks other tests.
 *
    ...
    public function testExecuteWithSomeOptions(): void
    {
        $this->syncService->expects($this->once())
            ...
            ->with($this->callback(function (InputOptionsDAO $inputOptionsDAO) {
                ...
                $this->assertSame(['123', '345'], $inputOptionsDAO->getMilexObjectIds()->getObjectIdsFor(Contact::NAME));
        ...
        $code = $this->commandTester->execute([
            ...
            '--disable-push'     => true,
            '--milex-object-id' => ['contact:123', 'contact:345'],
        ]);

...
use Milex\IntegrationsBundle\Event\FormLoadEvent;
use Milex\IntegrationsBundle\Exception\IntegrationNotFoundException;
use Milex\IntegrationsBundle\Form\Type\IntegrationConfigType;
use Milex\IntegrationsBundle\Helper\ConfigIntegrationsHelper;
use Milex\IntegrationsBundle\Helper\FieldMergerHelper;
use Milex\IntegrationsBundle\Helper\FieldValidationHelper;
use Milex\IntegrationsBundle\Integration\BasicIntegration;
use Milex\IntegrationsBundle\Integration\Interfaces\ConfigFormAuthInterface;
use Milex\IntegrationsBundle\Integration\Interfaces\ConfigFormAuthorizeButtonInterface;
use Milex\IntegrationsBundle\Integration\Interfaces\ConfigFormCallbackInterface;
...
class ConfigController extends AbstractFormController
{
    ...
    public function editAction(Request $request, string $integration)
    {
        ...
        $this->integrationsHelper = $this->get('milex.integrations.helper.config_integrations');
    ...
    private function submitForm()
    {
        ...
        if ($this->integrationObject instanceof ConfigFormSyncInterface) {
            ...
            $fieldValidator = $this->get('milex.integrations.helper.field_validator');
    ...
    private function getForm()
    {
        return $this->get('form.factory')->create(
            ...
            [
                'action'      => $this->generateUrl('milex_integration_config', ['integration' => $this->integrationObject->getName()]),
                'integration' => $this->integrationObject->getName(),
            ]
        );
    }
        ...
        return $this->delegateView(
            [
                ...
                'passthroughVars' => [
                    ...
                    'milexContent' => 'integrationsConfig',
                    'route'         => false,
                ],
            ]
        );

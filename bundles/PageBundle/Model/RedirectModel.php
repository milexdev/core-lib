...
class RedirectModel extends FormModel
{
     ...
     * {@inheritdoc}
     *
     * @return \Milex\PageBundle\Entity\RedirectRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexPageBundle:Redirect');
    }
    ...
    /**
     * Generate a Milex redirect/passthrough URL.
     *
     ...
     *
     * Use Milex\PageBundle\Model\TrackableModel::getTrackableByUrl() if associated with a channel
     *
     * @param  $url
     *
     * @return Redirect|null

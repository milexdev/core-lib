...
use Milex\PageBundle\Event\UntrackableUrlsEvent;
...
class TrackableModel extends AbstractCommonModel
{
     ...
     * {@inheritdoc}
     *
     * @return \Milex\PageBundle\Entity\TrackableRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MilexPageBundle:Trackable');
    }
    ...
    protected function extractTrackablesFromHtml($html)
    {
        ...
        foreach ($links as $link) {
            ...
            if ($link->hasAttribute('milex:disable-tracking')) {

...
namespace Milex\ReportBundle\Tests\Builder;
...
final class MilexReportBuilderTest extends TestCase
{
    /**
    ...
    private function buildBuilder(Report $report): MilexReportBuilder
    {
        return new MilexReportBuilder(
            $this->dispatcher,
            $this->connection,
            $report,

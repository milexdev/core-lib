...
use Milex\LeadBundle\DataFixtures\ORM\LoadCompanyData;
use Milex\LeadBundle\DataFixtures\ORM\LoadLeadData;
use Milex\LeadBundle\DataFixtures\ORM\LoadLeadFieldData;
use Milex\LeadBundle\DataFixtures\ORM\LoadLeadListData;
use Milex\LeadBundle\Entity\LeadList;
use Milex\LeadBundle\Segment\ContactSegmentService;
use Milex\LeadBundle\Tests\DataFixtures\ORM\LoadClickData;
use Milex\LeadBundle\Tests\DataFixtures\ORM\LoadDncData;
use Milex\LeadBundle\Tests\DataFixtures\ORM\LoadPageHitData;
use Milex\LeadBundle\Tests\DataFixtures\ORM\LoadSegmentsData;
use Milex\LeadBundle\Tests\DataFixtures\ORM\LoadTagData;
use Milex\PageBundle\DataFixtures\ORM\LoadPageCategoryData;
use Milex\UserBundle\DataFixtures\ORM\LoadRoleData;
use Milex\UserBundle\DataFixtures\ORM\LoadUserData;
use PHPUnit\Framework\Assert;

/**
 * These tests cover same tests like \Milex\LeadBundle\Tests\Model\ListModelFunctionalTest.
 */
class ContactSegmentServiceFunctionalTest extends MilexMysqlTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->contactSegmentService = self::$container->get('milex.lead.model.lead_segment_service');
    }
    ...
    public function testSegmentRebuildCommand(): void
    {
        ...
        $this->em->getConnection()->query(sprintf('UPDATE %sleads SET title = NULL;', MILEX_TABLE_PREFIX));
        ...
        $this->runCommand('milex:segments:update', [

...
namespace Milex\LeadBundle\Tests\Controller\Api;
...
class LeadApiControllerFunctionalTest extends MilexMysqlTestCase
{
    public function testBatchNewEndpointDoesNotCreateDuplicates(): void
    {
        ...
        // Set first name as null - Milex should keep the value
    ...
    {
        // Create contact
        $emailAddress = uniqid('', false).'@milex.com';
    ...
    public function testAddAndRemoveDncToExistingContact(): void
    {
        ...
        // MANUAL (3) is the default value according to the dev docs: https://developer.milex.org/#add-do-not-contact

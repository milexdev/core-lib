...
use Milex\LeadBundle\Segment\Exception\FieldNotFoundException;
use Milex\LeadBundle\Segment\Exception\SegmentNotFoundException;
use Monolog\Logger;
...
class CheckQueryBuildersCommand extends ModeratedCommand
{
    ...
    {
        $this
            ->setName('milex:segments:check-builders')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->logger = $container->get('monolog.logger.milex');

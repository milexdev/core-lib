...
$view['slots']->set('milexContent', 'config');
$view['slots']->set('headerTitle', $view['translator']->trans('milex.config.header.index'));
...
<div class="box-layout">
    ...
    <div class="col-md-3 bg-white height-auto">
        <div class="pr-lg pl-lg pt-md pb-md">
            <?php if (!$isWritable): ?>
            <div class="alert alert-danger"><?php echo $view['translator']->trans('milex.config.notwritable'); ?></div>
            <?php endif; ?>
            <!-- Nav tabs -->
            ...
            <?php foreach ($configKeys as $i => $key) : ?>
                ...
                <li role="presentation" class="list-group-item <?php echo 0 === $i ? 'in active' : ''; ?>">
                    ...
                    <a href="#<?php echo $key; ?>" aria-controls="<?php echo $key; ?>" role="tab" data-toggle="tab" class="steps<?php echo $containsErrors; ?>">
                        <?php echo $view['translator']->trans('milex.config.tab.'.$key); ?>

...
class CampaignSubscriber implements EventSubscriberInterface
{
    ...
    public function onCampaignBuild(CampaignBuilderEvent $event)
    {
        ...
        $action = [
            'label'                  => 'milex.channel.message.send.marketing.message',
            'description'            => 'milex.channel.message.send.marketing.message.descr',
    ...
    public function onCampaignTriggerAction(PendingEvent $pendingEvent)
    {
        ...
        $pendingEvent->failRemaining($this->translator->trans('milex.channel.message.failed'));
    }

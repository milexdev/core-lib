...
$view['slots']->set('milexContent', 'message');
        ...
        <!--/ form detail collapseable toggler -->
            <div class="bg-auto bg-dark-xs">
                ...
                <div class="hr-expand nm">
                        <span data-toggle="tooltip" title="<?php echo $view['translator']->trans('milex.core.details'); ?>">
                                    ...
                                    <div class="col-md-6 va-m">
                                        <h5 class="text-white dark-md fw-sb mb-xs">
                                            <div><i class="fa fa-line-chart pull-left"></i>
                                                <span class="pull-left"> <?php echo $view['translator']->trans('milex.messages.processed.messages'); ?></span></div>
                                        </h5>
                                    </div>
                ...
                <ul class="nav nav-tabs pr-md pl-md">
                    ...
                    <li class="<?php echo $active; ?>">
                        <a href="#contacts-<?php echo $channel; ?>" role="tab" data-toggle="tab">
                            <?php echo ('all' !== $channel) ? $channels[$channel]['label'] : $view['translator']->trans('milex.lead.leads'); ?>
                        </a>
                    </li>
                    <?php $active = ''; ?>
                    <?php endforeach; ?>
            ...
            <div class="tab-content pa-md">
                ...
                <div class="tab-pane bdr-w-0 page-list<?php echo $active; ?>" id="contacts-<?php echo $channel; ?>">
                    <?php $message = ('all' === $channel) ? 'milex.channel.message.all_contacts' : 'milex.channel.message.channel_contacts'; ?>

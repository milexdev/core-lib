...
class AssetModel extends FormModel
{
    ...
    public function getLookupResults($type, $filter = '', $limit = 10)
    {
        ...
        switch ($type) {
            case 'asset':
                ...
                if ('milex_segment_action' === $request->get('_route') &&
    ...
    public function generateUrl($entity, $absolute = true, $clickthrough = [])
    {
        ...
        return $this->buildUrl('milex_asset_download', $slugs, $absolute, $clickthrough);
    }
    ...
    public function getDownloadsLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [], $canViewOthers = true)
    {
        ...
        $chart->setDataset($this->translator->trans('milex.asset.downloadcount'), $data);
    ...
    public function getUniqueVsRepetitivePieChartData($dateFrom, $dateTo, $filters = [], $canViewOthers = true)
    {
        ...
        $chart->setDataset($this->translator->trans('milex.asset.unique'), $unique);
        $chart->setDataset($this->translator->trans('milex.asset.repetitive'), $repetitive);

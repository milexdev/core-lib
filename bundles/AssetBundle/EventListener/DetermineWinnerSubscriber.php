    ...
    public function onDetermineDownloadRateWinner(DetermineWinnerEvent $event)
    {
        ...
        if (null != $startDate && !empty($ids)) {
            ...
            if ($counts) {
                ...
                $downloadsLabel = $translator->trans('milex.asset.abtest.label.downloads');
                $hitsLabel      = ('page' == $type) ? $translator->trans('milex.asset.abtest.label.hits') : $translator->trans('milex.asset.abtest.label.sentemils');

...
class FormSubscriber implements EventSubscriberInterface
{
    ...
    public function onFormBuilder(FormBuilderEvent $event)
    {
        $event->addSubmitAction('asset.download', [
            ...
            'label'              => 'milex.asset.asset.submitaction.downloadfile',
            'description'        => 'milex.asset.asset.submitaction.downloadfile_descr',
    ...
    public function onFormSubmitActionDownloadFile(SubmissionEvent $event): void
    {
        ...
        $msg = $message.$this->translator->trans('milex.asset.asset.submitaction.downloadfile.msg', [
            '%url%' => $url,
        ]);

                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'milex.asset.asset.size'
                                        ); ?></span></td>
                                <td><?php echo $activeAsset->getSize(); ?></td>
                            </tr>
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'milex.asset.asset.path.relative'
                                        ); ?></span></td>
                                <td><?php echo $assetDownloadUrl; ?></td>
                            </tr>
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'milex.asset.filename.original'
                                        ); ?></span></td>
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-2 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.asset.graph.line.downloads'); ?>
                                    </h5>
                                </div>
                                <div class="col-md-2 va-m text-center">
                                    <span class="text-white dark-md fw-sb mb-xs"><?php echo $view['translator']->trans('milex.asset.asset.downloads.total', ['count' => $stats['downloads']['total']]); ?></span>
                                    <span class="text-white dark-md fw-sb mb-xs">|</span>
                                    <span class="text-white dark-md fw-sb mb-xs"><?php echo $view['translator']->trans('milex.asset.asset.downloads.unique', ['count' => $stats['downloads']['unique']]); ?></span>
                                </div>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mt-sm mb-0">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $view['translator']->trans('milex.asset.asset.url'); ?></div>
            </div>

...
Mautic.assetOnLoad = function (container) {
    if (typeof milexAssetUploadEndpoint !== 'undefined' && typeof Mautic.assetDropzone == 'undefined' && mQuery('div#dropzone').length) {
...
Mautic.initializeDropzone = function() {
    ...
    if (typeof milexAssetUploadMaxSize !== 'undefined') {
        options.maxFilesize = milexAssetUploadMaxSize;
    }

    if (typeof milexAssetUploadMaxSizeError !== 'undefined') {
        options.dictFileTooBig = milexAssetUploadMaxSizeError;
    }

    if (typeof milexAssetUploadExtensions !== 'undefined') {
        options.acceptedFiles = milexAssetUploadExtensions;
    }

    if (typeof milexAssetUploadExtensionError !== 'undefined') {
        options.dictInvalidFileType = milexAssetUploadExtensionError;
    }

                        ...
                        <div class="col-xs-8 va-t">
                            <div class="panel-body">
                                ...
                                <h4 class="fw-sb mb-xs">
                                    <a href="<?php echo $view['router']->path('milex_contact_action', ['objectAction' => 'view', 'objectId' => $item['id']]); ?>" data-toggle="ajax">
                                        <span>
                                            <?php
                                            ...
                                            elseif (!empty($item['email'])):
                                                ...
                                                echo $view['translator']->trans('milex.lead.lead.anonymous');
                                            endif;
                                            ?>
                                        </span>
                                    </a>
...
<div class="panel-footer">
    <?php
    $link = (isset($link)) ? $link : 'milex_contact_index';

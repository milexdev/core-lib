...
$header = ($entity->getId()) ?
    $view['translator']->trans('milex.campaign.menu.edit',
        ['%name%' => $view['translator']->trans($entity->getName())]) :
    $view['translator']->trans('milex.campaign.menu.new');
    ...
    <div class="col-md-9 bg-auto height-auto bdr-r">
        <div class="pa-md">
            <?php if ($entity->getId() && $entity->isPublished()): ?>
                <div class="alert alert-danger"><p><?php echo $view['translator']->trans('milex.campaign.modify.warning'); ?></p></div>
            <?php endif; ?>

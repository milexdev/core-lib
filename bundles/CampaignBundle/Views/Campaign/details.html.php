...
<div class="box-layout">
    ...
    <div class="col-md-9 bg-white height-auto">
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle">
                                    <?php echo $view['translator']->trans('milex.campaign.leadsource.'.$sourceType); ?>
                                </td>
                                <td>
        ...
        <div class="bg-auto bg-dark-xs">
                ...
                <span data-toggle="tooltip" title="Detail">
                    <a href="javascript:void(0)" class="arrow text-muted collapsed" data-toggle="collapse"
                       data-target="#campaign-details"><span
                            class="caret"></span> <?php echo $view['translator']->trans('milex.core.details'); ?></a>
                </span>
            </div>
            <!--/ campaign detail collapseable toggler -->

            <?php echo $view['content']->getCustomContent('left.section.top', $milexTemplateVars); ?>
            <!-- some stats -->
            <div class="pa-md">
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="panel-body box-layout">
                                <div class="col-md-3 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('milex.campaign.stats'); ?>
                                    </h5>
                                </div>
            ...
            <?php echo $view['content']->getCustomContent('details.stats.graph.below', $milexTemplateVars); ?>
                ...
                <?php if ($preview): ?>
                     <li class="<?php if ('preview' == $firstTab): echo 'active'; endif; ?>">
                        <a href="#preview-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.campaign.preview.header'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($decisions): ?>
                    <li class="<?php if ('decision' == $firstTab): echo 'active'; endif; ?>">
                        <a href="#decisions-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.campaign.event.decisions.header'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($actions): ?>
                    <li class="<?php if ('action' == $firstTab): echo 'active'; endif; ?>">
                        <a href="#actions-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.campaign.event.actions.header'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($conditions): ?>
                    <li class="<?php if ('condition' == $firstTab): echo 'active'; endif; ?>">
                        <a href="#conditions-container" role="tab" data-toggle="tab">
                            <?php echo $view['translator']->trans('milex.campaign.event.conditions.header'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <li class="">
                    <a href="#leads-container" role="tab" data-toggle="tab">
                        <?php echo $view['translator']->trans('milex.lead.leads'); ?>
                    </a>
                </li>
                <?php echo $view['content']->getCustomContent('tabs', $milexTemplateVars); ?>
            </ul>
            <!--/ tabs controls -->
        </div>
        ...
        <div class="tab-content pa-md">
            ...
            <div class="tab-pane fade in bdr-w-0 page-list" id="leads-container" data-target-url="<?php
                    echo $view['router']->url(
                        ...
                        ['objectId' => $campaign->getId(), 'page' => $app->getSession()->get('milex.campaign.contact.page', 1)]
                    );
                ?>">
                <div class="spinner"><i class="fa fa-spin fa-spinner"></i></div>
                <div class="clearfix"></div>
            </div>
            <?php echo $view['content']->getCustomContent('tabs.content', $milexTemplateVars); ?>
        </div>
        <!--/ end: tab-content -->

        <?php echo $view['content']->getCustomContent('left.section.bottom', $milexTemplateVars); ?>
    </div>
    <!--/ left section -->

    <!-- right section -->
    <div class="col-md-3 bg-white bdr-l height-auto">
        <?php echo $view['content']->getCustomContent('right.section.top', $milexTemplateVars); ?>
        <?php echo $view->render('MauticCoreBundle:Helper:recentactivity.html.php', ['logs' => $logs]); ?>
        <?php echo $view['content']->getCustomContent('right.section.bottom', $milexTemplateVars); ?>
    </div>
    <!--/ right section -->
</div>
<!--/ end: box layout -->

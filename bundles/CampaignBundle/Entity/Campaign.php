...
class Campaign extends FormEntity implements PublishStatusIconAttributesInterface
{
    ...
    {
        return [
            'data-message'      => 'milex.campaign.form.confirmation.message',
            'data-confirm-text' => 'milex.campaign.form.confirmation.confirm_text',
            'data-cancel-text'  => 'milex.campaign.form.confirmation.cancel_text',
        ];
    }
}

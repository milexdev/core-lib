...
class EventType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (in_array($options['data']['eventType'], ['action', 'condition'])) {
            $label = 'milex.campaign.form.type';

            $choices = [
                'immediate' => 'milex.campaign.form.type.immediate',
                'interval'  => 'milex.campaign.form.type.interval',
                'date'      => 'milex.campaign.form.type.date',
            ];
            ...
            $builder->add(
                ...
                [
                    ...
                    'attr'              => [
                        ...
                        'tooltip'  => 'milex.campaign.form.type.help',
                    ],
                    'data'        => $triggerMode,
                ]
            );
            ...
            $builder->add(
                ...
                [
                    'choices'     => [
                        'milex.campaign.event.intervalunit.choice.i' => 'i',
                        'milex.campaign.event.intervalunit.choice.h' => 'h',
                        'milex.campaign.event.intervalunit.choice.d' => 'd',
                        'milex.campaign.event.intervalunit.choice.m' => 'm',
                        'milex.campaign.event.intervalunit.choice.y' => 'y',
                    ],
                    'multiple'          => false,
                    'label_attr'        => ['class' => 'control-label'],
                    'label'             => false,
            ...
            $builder->add(
                ...
                [
                    ...
                    'choices'  => [
                        'milex.report.schedule.day.monday'     => 1,
                        'milex.report.schedule.day.tuesday'    => 2,
                        'milex.report.schedule.day.wednesday'  => 3,
                        'milex.report.schedule.day.thursday'   => 4,
                        'milex.report.schedule.day.friday'     => 5,
                        'milex.report.schedule.day.saturday'   => 6,
                        'milex.report.schedule.day.sunday'     => 0,
                        'milex.report.schedule.day.week_days'  => -1,
                    ],
                    'expanded'          => true,
                    'multiple'          => true,
                    'required'          => false,

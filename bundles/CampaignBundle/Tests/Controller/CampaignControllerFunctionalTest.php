...
class CampaignControllerFunctionalTest extends AbstractCampaignTest
{
    ...
    protected function setUp(): void
    {
        ...
        parent::setUp();
        $this->campaignModel      = self::$container->get('milex.model.factory')->getModel('campaign');
        $this->campaignLeadsLabel = self::$container->get('translator')->trans('milex.campaign.campaign.leads');
    }

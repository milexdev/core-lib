...
class LegacyEventDispatcherTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->milexFactory      = $this->createMock(MauticFactory::class);
    ...
    public function testAllEventsAreFailedWithBadConfig(): void
    {
        ...
        $this->getLegacyEventDispatcher()->dispatchCustomEvent($this->config, $logs, false, $this->pendingEvent, $this->milexFactory);
    }

...
namespace Milex\EmailBundle\Tests\Command;

use Milex\CoreBundle\Helper\CoreParametersHelper;
use Milex\EmailBundle\Command\ProcessEmailQueueCommand;
...
class ProcessEmailQueueCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCommandWhenQueueIsDisabled()
    {
        ...
        $this->assertSame("Milex is not set to queue email.\n", $output->fetch());
    }
    ...
    public function testCommandWhenQueueIsEnabled()
    {
        ...
        $tmpSpoolDir            = sys_get_temp_dir().'/milexSpoolTestDir';
        ...
        $this->coreParametersHelper->method('get')
            ->withConsecutive(
                ['mailer_spool_type'],
                ['milex.mailer_spool_path'],
                ['milex.mailer_spool_msg_limit']
            )

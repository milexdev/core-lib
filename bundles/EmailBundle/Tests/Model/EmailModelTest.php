...
use Milex\ChannelBundle\Entity\MessageRepository;
...
use Milex\CoreBundle\Test\Doctrine\DBALMocker;
...
use Milex\LeadBundle\Entity\FrequencyRuleRepository;
...
use Milex\PageBundle\Entity\TrackableRepository;
    ...
    public function testVariantEmailWeightsAreAppropriateForMultipleContacts(): void
    {
        ...
        $this->entityManager->expects($this->any())
            ...
            ->will(
                $this->returnValueMap(
                    [
                        ['MilexLeadBundle:FrequencyRule', $this->frequencyRepository],
                        ['MilexEmailBundle:Email', $this->emailRepository],
                        ['MilexEmailBundle:Stat', $this->statRepository],
                    ]
                )
            );
            ...
            ->will(
                $this->returnValueMap(
                    [
                        ...
                        ['MilexEmailBundle:Stat', $this->statRepository],
                        ['MilexLeadBundle:FrequencyRule', $this->frequencyRepository],
                        ['MilexChannelBundle:MessageQueue', $this->createMock(MessageRepository::class)],
                    ]
                )
            );
        $leadEntity = (new Lead())
        ...
        $this->entityManager->expects($this->any())
            ...
            ->will(
                $this->returnValueMap(
                    [
                        ['MilexEmailBundle:Stat', $this->statRepository],
                        ['MilexLeadBundle:DoNotContact', $doNotContactRepo],
                        ['MilexPageBundle:Trackable', $trackableRepo],
                    ]
                )
            );

...
namespace Milex\InstallBundle\Tests\Install;
...
class InstallSchemaTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->dbParams = [
            ...
            'table_prefix'  => MILEX_TABLE_PREFIX,
            'backup_prefix' => 'bak_',
        ];
    ...
    public function testBackupIndexesWithConfigOptions(): void
    {
        ...
        $milexTables = [$this->indexTableName => $this->dbParams['backup_prefix'].$this->indexTableName];

        $sql = $method->invokeArgs($schemaHelper, [$tables, $milexTables, $this->dbParams['backup_prefix']]);

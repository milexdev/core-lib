    ...
    loadScript: function (url, onLoadCallback, alreadyLoadedCallback) {
        ...
        mQuery.getScript(url, function (data, textStatus, jqxhr) {
            if (textStatus == 'success') {
                ...
                } else if (typeof Mautic[milexContent + "OnLoad"] == 'function') {
                    // Likely a page refresh; execute onLoad content
                    if (typeof Mautic.loadedContent[milexContent] == 'undefined') {
                        Mautic.loadedContent[milexContent] = true;
                        Mautic[milexContent + "OnLoad"]('#app-content', {});
                    }
                }
            }
        });

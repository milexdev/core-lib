...
namespace Milex\CoreBundle\Test\Hooks;
 ...
 *
 * Example of usage: `MILEX_TEST_EXECUTE_TEST_AFTER="Fully\\Qualified\\Class\\NameTest" bin/phpunit`.
 */
class MilexExtension implements AfterTestHook, BeforeFirstTestHook
{
    public function executeAfterTest(string $test, float $time): void
    {
        $testClass = getenv('MILEX_TEST_EXECUTE_TEST_AFTER');
    ...
    public function executeBeforeFirstTest(): void
    {
        if (!defined('MILEX_TABLE_PREFIX')) {
            ...
            define('MILEX_TABLE_PREFIX', 'prefix'.$prefix);

...
// Ensure the milex.db_table_prefix is set to our phpunit configuration.
...
$container->setParameter('milex.api_enabled', true);
$container->setParameter('milex.api_enable_basic_auth', true);
